...
class LoginViewController: UIViewController {
    ...
    @IBAction func logginButtonTapped(sender: UIButton) {
    
        let userId:NSString = userIdTextField.text!
        let userPassword:NSString = userPasswordTextField.text!
        
        if( userId.isEqualToString("") || userPassword.isEqualToString("") ){
            ...
            let post:NSString = "Identifiant=\(userId)&Mdp=\(userPassword)"
